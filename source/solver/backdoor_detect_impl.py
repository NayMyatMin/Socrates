...
class BackdoorDetectImpl():
    def __transfer_model(self, model, sub_model, dataset):
        ...
        for name, param in params:
            if dataset == 'mnist' and ('fc4.weight' in name or 'fc4.bias' in name):
                ...
                dict_params[name].data.copy_(param.data)
            elif dataset == 'cifar10_wrn16_1' and ('fc.weight' in name or 'fc.bias' in name):
                dict_params[name].data.copy_(param.data)
    ...
    def solve(self, model, assertion, display=None):
        ...
        elif dataset == 'cifar10_inv' or dataset == 'cifar10_sem' or dataset == 'cifar10_tro' or dataset=='cifar':
        ...
        elif dataset == 'cifar10_wrn16_1':
            last_layer = 'avgpool'
            file_name = './backdoor_models/WRN-16-1-S-model_best1.pth.tar'
